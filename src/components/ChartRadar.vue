    ...
    export default {
        ...
        methods: {
            ...
            xTextCoordinate(index) {
                ...
                return calculateXCoordinate(newAngle, parseFloat(this.radius) + 63, this.originPoint) - 52;
            },
            ...
            buildPoints() {
                ...
                for (let i = 0; i < this.statsLength; i++) {
                  if(this.stats[i].value !== 0) {
                    ...
                    let value = this.stats[i].percent;
            ...
            shortNames() {
                ...
                for (let i = 0; i < this.statsLength; i++) {
                    ...
                    if (objectHasProperty(stat, 'shortName')) {
                        shortNames.push(setProperty(stat, 'shortName', stat.name));
                    } else {
...
<style>
.v-radar{
  background: #fff url(../assets/chart-radar-bg.png) no-repeat center center;
}
.v-radar::after {
    content: '';
    display: block;
